...
3.execute "Set-ExecutionPolicy RemoteSigned" command under powershell(run as administrator)

4.add "ajaxminifier.ps1" to project
   edit ajaxminifier.ps1 -> 	$execPath="C:\Program Files (x86)\Microsoft\Microsoft Ajax Minifier\ajaxmin.exe" //change your ajaxmin.exe current path.
