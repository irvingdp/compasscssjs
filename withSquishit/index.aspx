<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="withSquishit.index" %>
...
<head>
    ...
    <script type="text/javascript" src="/js/index.js"></script>	-->
        <%= SquishIt.Framework.Bundle.Css().
                   Add("~/stylesheets/jquery.dropdown.css").
                   Add("~/stylesheets/index.css").             
                   Render("~/stylesheets/site_#.css") %>
         <%= SquishIt.Framework.Bundle.JavaScript().
                   Add("~/js/jquery.1.8.0.js").
                   Add("~/js/jquery.dropdown.js").
                   Add("~/js/index.js").
                   Render("~/js/site_#.js") %>
</head>
<body>
    ...
    <h3>todo: be merage one image (css sprite)</h3>
	<p>
		click here: <span class="example" data-dropdown="#dropdown-5" id="spandropdown5">Example</span>
	</p> 
